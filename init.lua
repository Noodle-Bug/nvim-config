...
local corePlugins = {
	...
	},
	{
		...
		config = function()
			...
			vim.keymap.set("n", "\\", oil.open_float, { desc = "Open parent directory in oil" })
		end
	},
	{
		'Wansmer/treesj',
	...
	}, -- Theme
	{
		...
		config = function()
			...
			dashboard.section.buttons.val = {
				dashboard.button('c', '  - Open config', ":execute 'e ' . stdpath('config')<CR>"),
